        ...
        extend(ControlManager()) {
            ...
            extend {
                ...
                else
                {
                    ...
                    val end = Vector2(start.x + x_diff, start.y + y_diff)
...
fun computeCollisionVelocity(position1: Position, velocity1: Velocity,
...
fun Program.rollResistance(velocity: Velocity, rollingResistance: Double): Velocity {
    val newVelocity = Velocity(velocity.x * (1.0 - rollingResistance), velocity.y * (1.0 -rollingResistance))
    return newVelocity
}

fun Program.checkCushion(position: Position, velocity: Velocity, tableUpperLeft: Vector2, tableSize: Vector2): Velocity {
